...
// Calculate total profit/loss and monthly changes
...
let maxIncreaseIndex = monthlyChanges.indexOf(maxIncrease) + 1; // Adding 1 to get the correct index
let maxDecreaseIndex = monthlyChanges.indexOf(maxDecrease) + 1; // Adding 1 to get the correct index

// Output the results
console.log("Total Months: " + totalMonths);
console.log("Total Profit/Loss: " + totalProfitLoss);
console.log("Average Change: " + averageChange);
console.log("Greatest Increase in Profits: " + finances[maxIncreaseIndex][0] + " ($" + maxIncrease + ")");
console.log("Greatest Decrease in Profits: " + finances[maxDecreaseIndex][0] + " ($" + maxDecrease + ")");
...
for (let i = 1; i < finances.length; i++) {
        // Calculate the difference between the current and previous profit/loss values
        const difference = finances[i][1] - finances[i - 1][1];
      
        // Check if the current difference is greater than the greatest increase
      ...
      // Print the greatest increase and its corresponding date
...
const greatestIncreaseAmount = finances[greatestIncreaseIndex][1];
